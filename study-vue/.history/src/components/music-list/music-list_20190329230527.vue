...
export default {
    ...
    watch: {
        scrollY(newVal){
            ...
            if(-newVal < minTransalteY && newVal < 0){
                this.$refs.layer.style.transform = `translate3d(0,${newVal}px,0)`
                this.$refs.playBtn.style.display = 'none'
                // this.$refs.bgImage.style.paddingTop = 0
                // this.$refs.bgImage.style.height = `${-newVal}px`

            }else if(-newVal > minTransalteY){
                this.$refs.layer.style.transform = `translate3d(0,${-minTransalteY}px,0)`
                this.$refs.bgImage.style.paddingTop = 0
